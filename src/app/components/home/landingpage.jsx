...
export default function KEALandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        id="home"
        className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-blue-50 via-white to-cyan-50 relative overflow-hidden"
      >
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <p className="text-gray-600 text-sm">
                  Connect with engineers worldwide
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <p className="text-gray-600 text-sm">
                  Achieve greatness in your field
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <input
              ...
              required
              className="flex-1 px-6 py-4 rounded-xl  bg-white  border border-gray-300  text-gray-900  focus:outline-none  focus:ring-4 focus:ring-blue-300  focus:border-blue-400"
            />
