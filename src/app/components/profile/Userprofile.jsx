...
export default function UserProfile() {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      setIsEditing(false);
      await fetchUserProfile(); // Refresh data from backend
    } catch (err) {
              ...
              <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-700">id-proof.pdf</span>
                      </div>
                      <button className="text-xs text-blue-600 hover:text-blue-700">Verified</button>
                    </div>
                    <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                      <div className="flex items-center gap-2">
                        <FileText className="w-4 h-4 text-gray-600" />
                        <span className="text-xs text-gray-700">Engineering-degree-certificate.pdf</span>
                      </div>
                      <button className="text-xs text-blue-600 hover:text-blue-700">Verified</button>
                    </div>
                    <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                      <div className="flex items-center gap-2">
                        <FileText className="w-4 h-4 text-gray-600" />
                        <span className="text-xs text-gray-700">Experience-letter_ABC.pdf</span>
                      </div>
                      <button className="text-xs text-gray-600 hover:text-gray-700">Not Active</button>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-5">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-full flex items-center justify-center text-white text-sm font-bold">
                        RS
                      </div>
                      <div className="flex-1">
                        <p className="text-sm font-medium text-gray-900">R. Suresh • Referred</p>
                        <p className="text-xs text-gray-500">KEA Lifetime Member • Verified</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium text-gray-900">M. Naveen Kumar • Referred</p>
                        <p className="text-xs text-gray-500">KEA Lifetime Member • Verified</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-5">
                  ...
                  <p className="text-xs text-gray-600 mb-3">
                    {calculateProfileCompletion() === 100 
                      ...
                      : 'Your profile is still incomplete. Add more skills and experiences to reach 100%.'}
                  </p>
                  <button 
                    onClick={() => setIsEditing(true)}
